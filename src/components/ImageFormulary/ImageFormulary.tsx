import styles from './ImageFormulary.module.css'

export default function ImageFormulary() {
    return (
        <div className={styles.camp__cont__img}>
            <svg className={styles.camp__img} xmlns="http://www.w3.org/2000/svg" width="274" height="568" fill="none" viewBox="0 0 274 568">
